...
#import "KUChartTableViewController.h"
#import "PNChart.h"
...
@implementation KUChartTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    }else if ([segue.identifier isEqualToString:@"pieChart"])
    {
        ...
        NSArray *items = @[[PNPieChartDataItem dataItemWithValue:10 color:PNGreen],
